...
To enable logging, you should add a simplelogger.properties file for configuring the simple logger, default Dbb/groovyz logging,
and the option to enable logging in 
