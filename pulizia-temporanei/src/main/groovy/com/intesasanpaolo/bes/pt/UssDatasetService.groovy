...
/**
 * USS filesystem implementation of DatasetService.
 * Simulates z/OS datasets as directories on USS filesystem.
 *
 * <p>Path mapping: //MY.TEMP.ABC → <baseDir>/MY/TEMP/ABC/
 * Used for integration testing on USS before z/OS deployment.
 */
@Slf4j
class UssDatasetService implements DatasetService {
    String baseDir

    UssDatasetService(String baseDir) {
